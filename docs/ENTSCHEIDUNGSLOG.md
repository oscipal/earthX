...
| — | Code-Lizenz für das öffentliche Repo. **Hinweis 2026-09-18:** Im Repo liegt bereits eine `LICENSE` (MIT, seit dem ersten Commit). ENTSCHEIDUNGEN §4 geht von "keine LICENSE-Datei" aus; Otto bestätigt oder ersetzt sie | offen (Otto) | ENTSCHEIDUNGEN §4 |
