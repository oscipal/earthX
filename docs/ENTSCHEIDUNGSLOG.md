...
| 2026-09-18 | M0 Schritt 6: Entscheidungsvorlage für den ersten token-freien Datensatz als ADR-Entwurf `docs/adr/0003-erster-datensatz.md` (Optionen EOPF Sentinel Zarr Samples, Sentinel-2 L2A COG über Earth Search, Planetary Computer, Copernicus DEM). Empfehlung: Sentinel-2 L2A COG zuerst als Träger des Umbaus, EOPF Zarr unmittelbar als zweiter Datensatz. Erreichbarkeitstest aus der Cloud nicht möglich (Egress gesperrt); keine Lizenz-, Zugangs- oder Laufzeitangabe am Primärdokument geprüft | Vorschlag, Entscheidung bei Otto | adr/0003; ENTSCHEIDUNGEN §6; projektuebersicht §5; KLAERUNGEN B11, B12, B13 |
| — | Erster token-freier Datensatz (Kandidat laut früherer Planung: EOPF Sentinel Zarr Samples) | offen, Vorlage liegt vor: adr/0003 | ENTSCHEIDUNGEN §6; adr/0003 |
